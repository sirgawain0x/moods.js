<template>
  <button
    @click="login()"
    class="col-span-2 font-family-[Helvetica,Arial,sans-serif] text-center text-white font-bold flex items-center border-0 h-7 text-sm px-4 justify-center bg-[#CC0FE0] rounded-md transition-all duration-[0.07s] ease-in-out hover:bg-[#D127E3] hover:scale-[1.04] active:bg-[#A30CB3]"
  >
    <svg
      width="18"
      height="18"
