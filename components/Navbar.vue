...
<template>
  <div class="navbar bg-base-300 border-b-2 border-primary-content">
    <div class="navbar-start">
      ...
      <button
        class="btn btn-ghost text-xl font-black gap-px rounded-md"
        onclick="menu_modal.showModal()"
      >
        <Icon
          name="streamline:ai-generate-variation-spark-solid"
    ...
    <div class="navbar-center hidden lg:flex">
      <ul class="menu menu-horizontal px-1 gap-2 align-bottom">
        ...
        <li>
          <a href="https://github.com/creativeplatform" target="_blank">
    ...
    <div class="navbar-end">
      ...
      <div v-else>
        <button
          @click="login()"
          class="col-span-2 ml-3 font-family-[Helvetica,Arial,sans-serif] text-center text-white font-bold flex items-center border-0 h-7 text-sm px-4 justify-center bg-[#CC0FE0] rounded-md transition-all duration-[0.07s] ease-in-out hover:bg-[#D127E3] hover:scale-[1.04] active:bg-[#A30CB3]"
        >
          <svg
            width="18"
            height="18"
          ...
          >
            ...
            >
              <g id="assets" transform="translate(-1555.000000, -2588.000000)">
                <g
                  id="audiusLogoGlyph"
                  transform="translate(1555.000000, 2588.000000)"
                >
                  <path
    ...
    <div class="modal-box bg-base-300">
      ...
      <div class="grid grid-cols-2 gap-2 mt-4">
        ...
        <NuxtLink
          ...
          class="flex rounded-lg bg-base-100 h-20 justify-center items-center flex-col"
        >
          <Icon name="streamline:information-circle-solid" /> Info
          <!-- Then Discovery-->
        </NuxtLink>
