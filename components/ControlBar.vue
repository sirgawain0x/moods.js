...
function setupMediaSession(superTrackData: any) {
  if (navigator.mediaSession) {
    navigator.mediaSession.metadata = new MediaMetadata({
      ...
      artist: superTrackData.user.name + " on GENESIS™",
      artwork: [
        {
    ...
    >
      ...
      <div class="flex items-center w-full">
        <div class="w-full">
          <div class="flex items-center justify-center mx-auto mb-1 self-end">
            ...
            >
              <Icon
                name="streamline:volume-level-high-solid"
                class="text-primary"
              />
            ...
            <dialog id="sound_modal_1" class="modal">
              <div
                class="absolute modal-box w-5 left-4 bottom-8 p-0 m-0 rounded-sm"
                style="height: 136px"
              >
                <input
                  type="range"
            ...
            <dialog id="sound_modal_3" class="modal">
              <div
                class="absolute bottom-28 modal-box flex items-center gap-2 p-2 rounded-lg w-10/12"
              >
            ...
            <div class="tooltip" data-tip="Not Implemented">
              ...
              >
                <Icon
                  name="streamline:play-list-folder-solid"
                  class="text-error"
                />
            ...
            >
              <Icon
                name="streamline:button-previous-solid"
                class="text-primary"
              />
            ...
            <div class="tooltip" data-tip="Not Implemented">
              ...
              >
                <Icon
                  name="streamline:hearts-symbol-solid"
                  class="text-error"
                />
              ...
              <div class="modal-box h-96 w-96 relative overflow-y-auto">
                ...
                <div class="flex justify-center gap-2 z-10 sticky bottom-0">
                  ...
                  <button
                    ...
                    :class="[
                      isLooped
                        ? 'btn btn-success w-1/2 inline-block p-0 rounded-lg z-20'
                        : 'btn btn-default w-1/2 inline-block p-0 rounded-lg z-20',
                    ]"
                  >
                    <Icon
                      name="streamline:arrow-infinite-loop-solid"
      ...
      <div class="items-center justify-center hidden ms-auto md:flex">
        ...
        <dialog id="sound_modal_2" class="modal">
          <div
            class="absolute modal-box w-3 right-12 bottom-8 p-0 m-0 rounded-sm"
            style="height: 136px"
          >
            <input
              type="range"
