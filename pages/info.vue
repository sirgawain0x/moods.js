<template>
  <div class="flex flex-col items-center justify-center mb-32">
    <h1 class="text-center text-6xl font-black mt-8">What is GENESIS?</h1>
    <h1 class="text-center text-4xl font-black mt-8">Why GENESIS?</h1>
    <p class="text-center mt-4" style="width: 50%">
      GENESIS is your gateway to a world of curated music playlists and emerging
      artists. We're a community-driven platform designed to help you discover
      fresh sounds and connect with passionate music curators.
    </p>
    <h1 class="text-center text-4xl font-black mt-8">
      Which music services does Genesis support?
    </h1>
    <p class="text-center mt-4" style="width: 50%">
      Currently, we exclusively support music from Audius, a decentralized music
      platform. This allows us to offer GENESIS with minimal server fees,
      keeping the app accessible and sustainable. We have plans to integrate
