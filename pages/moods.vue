<template>
  <div class="flex flex-col items-center justify-center">
    <h1 class="text-center text-6xl font-black my-8">WIP</h1>
    <p class="mt-4 mb-2">Use what works instead ⬇️</p>
    <SearchBull placeholderText="I'm here to help you!" />
  </div>
  ...
  <div class="mx-4 lg:mx-16">
    ...
    <div class="grid grid-cols-3 lg:grid-cols-8 mt-4 gap-4">
      ...
      />
      <MoodCard
        gradient="bg-[url('/img/rainbow.webp')] bg-center bg-cover"
